...
Module yocto_carbondioxide
  ...
  REM --- (YCarbonDioxide implementation)

  Private _CarbonDioxideCache As New Hashtable()
  ...
  End Sub
    ...
    ''' </returns>
    '''/
    Public Shared Function FindCarbonDioxide(ByVal func As String) As YCarbonDioxide
      Dim res As YCarbonDioxide
      If (_CarbonDioxideCache.ContainsKey(func)) Then
        Return CType(_CarbonDioxideCache(func), YCarbonDioxide)
      End If
    ...
    REM --- (end of YCarbonDioxide implementation)
  ...
  Private Sub _CarbonDioxideCleanup()
  End Sub
