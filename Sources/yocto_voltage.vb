'*********************************************************************
'*
'* $Id: yocto_voltage.vb 12324 2013-08-13 15:10:31Z mvuilleu $
'*
...
Module yocto_voltage
  ...
  Public Delegate Sub UpdateCallback(ByVal func As YVoltage, ByVal value As String)
  ...
  REM --- (YVoltage implementation)

  Private _VoltageCache As New Hashtable()
  ...
  End Sub
    ...
    ''' </returns>
    '''/
    Public Shared Function FindVoltage(ByVal func As String) As YVoltage
      Dim res As YVoltage
      If (_VoltageCache.ContainsKey(func)) Then
        Return CType(_VoltageCache(func), YVoltage)
      End If
    ...
    REM --- (end of YVoltage implementation)
