/*********************************************************************/
 *
 *    Y O C T O P U C E    L I B R A R Y    f o r    V B  . N e t
 *
 * - - - - - - - - - - - License information: - - - - - - - - - - -
 *
...
Examples/            Directory with sample programs in VisualBasic .NET
Sources/             Source code of the high-level library (in VisualBasic)
...
as well as some GUI-enabled VisualBasic .NET applications, included as executable
